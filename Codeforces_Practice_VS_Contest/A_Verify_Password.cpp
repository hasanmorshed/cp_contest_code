...
void solve()
{
    ...
    if (n == 1)
    {
        if ((int(s[0]) >= 48 and int(s[0]) <= 57) or (int(s[0]) >= 97 and int(s[0]) <= 122))
        {
            yes;
        }
        else
    ...
    for (int i = 1; i < n; ++i)
    {
        if ((int(s[i]) >= 48 and int(s[i]) <= 57) or (int(s[i]) >= 97 and int(s[i]) <= 122))
        {

            if ((int(s[i - 1]) >= 48 and int(s[i - 1]) <= 57) or (int(s[i - 1]) >= 97 and int(s[i - 1]) <= 122))
            {

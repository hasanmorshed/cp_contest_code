...
void solve()
{
    ...
    if (n % 2 == 0)
    {
        cout << (*max_element(v.begin(), v.end())) + (n / 2) << endl;
    }
    ...
    else
    {
        ...
        int maxi_odd = *max_element(vv.begin(), vv.end()) + (vv.size());
        int maxi_even = *max_element(vvv.begin(), vvv.end()) + (vvv.size());
        cout << max(maxi_odd, maxi_even) << endl;
    }
}

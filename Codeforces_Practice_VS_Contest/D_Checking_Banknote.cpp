...
void solve()
{
 ...
 else if((n>=2 and s[n-1]=='0' and s[n-2]!='0') or (n==1 and s[n-1]=='0')){
    cout<<"Dashak."<<endl;
 }
 else if((n>=3 and s[n-1]=='0' and s[n-2]=='0' and s[n-3]!='0') or (n==2 and s[n-1]=='0' and s[n-2]=='0')){
    cout<<"Shatak."<<endl;
 }
 else if((n>=4 and s[n-1]=='0' and s[n-2]=='0' and s[n-3]=='0' and s[n-4]!='0') or (n==3 and s[n-1]=='0' and s[n-2]=='0' and s[n-3]!='0')){
